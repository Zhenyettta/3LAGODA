...
urlpatterns = [
    ...
    path('home/customers_list/get_customer_percent_by_name/', views.get_customer_percent_by_name,
         name='get_customer_percent_by_name'),
    ...
    path('home/my_info/watch/<int:id>/', views.watch_check_sales, name='watch_check_sales'),
